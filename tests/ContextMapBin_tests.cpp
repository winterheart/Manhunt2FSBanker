...
TEST(Manhunt2FSBanker, ContextMapBin) {
  ...
  std::fstream context_map_bin_stream("Samples/context_map.bin", std::ios::binary | std::ios::in);
  ...
  EXPECT_TRUE(compare_files("Samples/context_map.bin", context_map_bin_tmp_file));
